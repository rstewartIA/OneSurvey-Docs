...
<div class="os-screenshot">
  <div class="os-screenshot-card">
    <img src="../../assets/images/mobile-sites-page.png" alt="Mobile sites page showing the site list">
  </div>
  <p class="os-screenshot-caption">Mobile site list with search, stage, client, and site number details.</p>
</div>
