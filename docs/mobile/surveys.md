...
<div class="os-screenshot">
  <div class="os-screenshot-card">
    <img src="../../assets/images/mobile-survey-page.png" alt="Mobile survey page showing the survey element list">
  </div>
  <p class="os-screenshot-caption">Mobile survey view with the element list and quick access to element details.</p>
</div>
