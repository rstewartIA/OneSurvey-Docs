...
<div class="os-screenshot">
  <div class="os-screenshot-card">
    <img src="../../assets/images/onesnap-photos.png" alt="OneSnap photo gallery">
  </div>
  <p class="os-screenshot-caption">OneSnap gallery for high-volume field photo capture.</p>
</div>
...
<div class="os-screenshot">
  <div class="os-screenshot-card">
    <img src="../../assets/images/onesnap-geotag.png" alt="OneSnap map and geotag context">
  </div>
  <p class="os-screenshot-caption">Map context with geotag support for captured photos.</p>
</div>
