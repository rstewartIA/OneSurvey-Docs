...
<div class="os-screenshot">
  <div class="os-screenshot-card">
    <video controls preload="metadata" playsinline style="width: 100%; height: auto; display: block;" src="../../assets/videos/Site-Creation.mp4">
      Your browser does not support the video tag.
    </video>
  </div>
  <p class="os-screenshot-caption">Create a site from the Add Site modal.</p>
</div>
...
If **Add Site** is not visible, your current access does not allow site creation.
...
| **Site ID** | Yes | Short identifier for the site. Spaces are converted to hyphens. |
...
1. In the Site list, select the team avatar stack (or **+**) for a site.
2. Search users by name or email.
3. Add people to the invite list.
4. Set site access level.
5. Select **Save**.
...
|---|---|---|
| **Edit** | Full seat users | Full survey and Site actions. |
...
From the row action menu in Site list:
- **Edit**: update site details.
- **Copy Site**: duplicate a site and its content.
