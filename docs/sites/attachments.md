...
<div class="os-screenshot">
  ...
  <p class="os-screenshot-caption">Attachments tab for uploading and managing Site files.</p>
</div>
...
Keep Attachments current. When files are updated — for example, a revised floor plan or a final spec sheet — upload the new version and remove or clearly rename the old one. Teams rely on this tab as a shared source of truth for Site reference files.
