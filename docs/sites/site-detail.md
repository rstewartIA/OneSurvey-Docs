...
Site Detail is the main workspace for a site. When you open a site from the Site list, you land here by default on the **Surveys** tab. All of the site's work — surveys, elements, data, files, photos, assignments, and tickets — is organized across tabs at the top of the page.
...
<div class="os-screenshot">
  <div class="os-screenshot-card">
    <img src="../../assets/images/site-detail.png" alt="Site detail page with tabs">
  </div>
...
The tabs support a natural Site progression:
