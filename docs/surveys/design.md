...
## Overview
The Element Sidebar opens when you select an element on the survey canvas. It is the main place to update element details, field documentation, and workflow actions before you move to the next location.
...
2. Use the sidebar menus to update details and attach evidence.
3. Confirm the element looks correct in context.
4. Save and continue to the next element.
